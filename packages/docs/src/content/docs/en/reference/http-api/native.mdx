...
**Field Descriptions:**
- `ApiResponse<T>`: Global generic response wrapper, see [ApiResponse Wrapper Model](overview#native-api-wrapper-model-apiresponset)
...
- `ApiResponse<T>`: Generic response wrapper, see [ApiResponse Wrapper Model](overview#native-api-wrapper-model-apiresponset)
